...
This module provides tests for the functions uuid6() and uuid7() for
...
from app.utils.uuid6 import UUID, uuid6, uuid7
...
class UUIDTests(unittest.TestCase):
    ...
    @patch("app.utils.uuid6._last_v7_timestamp", 1)
    ...
    @patch("app.utils.uuid6._last_v6_timestamp", 1)
    ...
    #     cur_time = time_ns()
    #     uuid_7 = uuid7()
    #     self.assertAlmostEqual(uuid_7.time / 10**4, cur_time / 10**4, 5)
